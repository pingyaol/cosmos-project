...
colSums(data)
apply(data, 2, sd)
model_jitter <- lmer(total_UPDRS ~ Jitter_percent + Jitter_Abs + Jitter_RAP + Jitter_PPQ5 + Jitter_DDP + (1 + Jitter_percent | subject), data = data)

summary(model_jitter)


model_shimmer <- lmer(total_UPDRS ~ Shimmer + Shimmer_dB + Shimmer_APQ3 + Shimmer_APQ5 + Shimmer_APQ11 + Shimmer_DDA + (1 + Shimmer | subject), data = data)
